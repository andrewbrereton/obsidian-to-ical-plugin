...
class SettingsManager {
  ...
  public set isOnlyTasksWithoutDatesAreTodos(
    isOnlyTasksWithoutDatesAreTodos: boolean
  ) {
    this.settings.isOnlyTasksWithoutDatesAreTodos =
      isOnlyTasksWithoutDatesAreTodos
    this.saveSettings()
  }
  ...
  public set isDayPlannerPluginFormatEnabled(
